...
## Project Structure
    ...
    ├── testapiautocatalog_104661  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_104661`
...
2. Clone this repo and `cd testapiautocatalog_104661`
